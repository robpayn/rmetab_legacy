...
public class SatDOConc extends AbstractUpdaterDbl {
    ...
    {
        // Empirical relationship between saturated DO concentration and
    ...
    protected double initValue()
    {
        ...
        // including the molecular weight of oxygen gas (0.032 mg/umol)
    ...
    protected void setDependencies()
    {
        ...
        if (reaerationEdges.length == 1)
        {
            ...
            airpressure = (HStateDbl) getInitHState(((Edge) reaerationEdges[0]).getFrom(), Doxygen.Names.AIR_PRESSURE);
        }
        else
        {
        ...
        densityWater = (HStateDbl) getInitHState(DensityWater.class.getSimpleName());
